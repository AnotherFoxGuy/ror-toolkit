...
def show_error_dialog_non_wx(text, title):
    ...
    txt += "\n\t[Documents/Rigs of Rods Toolkit/logs/Crash.log]"
    txt += "\n\t[Documents/Rigs of Rods Toolkit/logs/Ogre.log] (if present)"
    txt += "\n\t[Documents/Rigs of Rods Toolkit/logs/editor.log] (if present)"
    txt += "\n\n ------------------------------------------------------------------------"
    txt += "\n\nError message: \n"
    txt += str(text)
...
def show_dialog_non_wx(text, title):
    wx.MessageDialog(None, text, title)
    # """
...
def write_crash_log_file():
    ...
    if sys.platform in ['win32', 'win64']:
        ...
        try:
            ...
            homedir = os.path.expanduser("~/Documents/Rigs of Rods toolkit")  # This is currently hardcoded anyway...
...
def main():
    ...
    try:
        ...
        sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "source/ror"))
        sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "source/roreditor"))
        sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "source/rortoolkit"))
        if sys.platform in ['win32', 'win64']:
            binaryRoR = 'RoR.exe'
        else:
            binaryRoR = 'RoR'
